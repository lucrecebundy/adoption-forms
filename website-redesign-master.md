...
| 22 | Future task: dedicated refund-policy page | ✅ Resolved 2026-05-12 | Page built at `/refund-policy/` (`refund-policy.html`). Locks the 7-day eligibility window, pre-delivery / post-delivery distinction, request mechanism (reply to order confirmation OR email `info@adoptionformsexpress.com`), 5–10 business day processing, and exceptions clause. Hosting decision: own site at `/refund-policy/` (chosen over ThriveCart-hosted or PDF). **Surface decision (locked 2026-05-05, preserved):** the page is NOT linked from the site footer. Link lives in post-purchase invoice/receipt only — visitors see the policy at the moment it matters rather than buried in marketing-page footers. The Terms of Use page's new "Refunds" section also defers to this page; sales-page FAQ Q6 and checkout-page reassurance lines remain the in-funnel surface. |
...
|---|---|---|---|
| **Master** | `website-redesign-master.md` | v1.18 | 🟡 Active |
| Homepage | `homepage-redesign-v1.md` | v2.13 | 🔵 Built (`homepage.html`), ready for WordPress deploy |
| Qualifier quiz | `qualifier-quiz-v1.md` | — | ⚪ Not started |
| Pricing | `pricing-page-v1.md` | — | ⚪ Not started |
| DFY minor child (sales + checkout) | `dfy-minor-child-page-v1.md` | v2.15 | 🔵 Built — `dfy-minor-child.html` (sales page) + `dfy-minor-child-checkout.html` (transactional checkout, ThriveCart product 10) both on disk, ready for WordPress deploy |
...
| DIY minor child (sales + checkout) | `diy-minor-child-page-v1.md` | v1.11 | 🔵 Built — `diy-minor-child.html` (sales page) + `diy-minor-child-checkout.html` (transactional checkout, ThriveCart product 4) both on disk, ready for WordPress deploy |
| DIY adult (sales + checkout) | `diy-adult-page-v1.md` | v1.8 | 🔵 Built — `diy-adult.html` (sales page) + `diy-adult-checkout.html` (transactional checkout, ThriveCart product 7) both on disk, ready for WordPress deploy |
