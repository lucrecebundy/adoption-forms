...
|---|---|---|---|
| **Master** | `website-redesign-master.md` | v1.15 | 🟡 Active |
...
| DFY minor child (sales + checkout) | `dfy-minor-child-page-v1.md` | v2.13 | 🔵 Built — `dfy-minor-child.html` (sales page) + `dfy-minor-child-checkout.html` (transactional checkout, ThriveCart product 10) both on disk, ready for WordPress deploy |
