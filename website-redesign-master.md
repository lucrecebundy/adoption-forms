...
| Patty Bales | Google (Sep 2020) | DFY adult — card 3; **also on DFY checkout page (`dfy-minor-child-checkout.html`) — compact two-up reassurance card** | ✅ Full text in doc spec — strong "no hidden fees" line; checkout page uses curated excerpt: *"Of course price seems to always play a role and she is very reasonable with no hidden fees!"* |
