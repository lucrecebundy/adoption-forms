...
|---|---|---|---|
| **Master** | `website-redesign-master.md` | v1.11 | 🟡 Active |
...
| DFY minor child (sales + checkout) | `dfy-minor-child-page-v1.md` | v2.9 | 🔵 Built — `dfy-minor-child.html` (sales page) + `dfy-minor-child-checkout.html` (transactional checkout, ThriveCart product 10) both on disk, ready for WordPress deploy |
