...
- Checkout page file: `dfy-adult-checkout.html` — URL: `/dfy-adult-checkout-page/` — houses the ThriveCart embed (account `adoptionssimplified`, product `8`, embed token `tc-adoptionssimplified-8-OBAALE`)
