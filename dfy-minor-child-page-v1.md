...
```html
<div class="tc-v2-embeddable-target" data-thrivecart-account="adoptionssimplified" data-thrivecart-tpl="v2" data-thrivecart-product="10" data-thrivecart-embeddable="tc-adoptionssimplified-10-UAXWPD"></div>
<script async src="//tinder.thrivecart.com/embed/v2/thrivecart.js" id="tc-adoptionssimplified-10-UAXWPD"></script>
```

Account `adoptionssimplified` · Product ID `10` · Embed token `tc-adoptionssimplified-10-UAXWPD`. Paste at both CTA locations (Section 4.2 hero + Section 4.7 final CTA) during HTML build.
...
| 8 | ThriveCart embed snippet | ✅ Resolved 2026-04-30 | Production snippet captured verbatim in Section 8. Account: `adoptionssimplified` · Product `10` · Embed token `tc-adoptionssimplified-10-UAXWPD`. To be pasted at both CTA locations during HTML build. |
