...
Same as DIY minor-child page — minimal nav, no menu items. Email link: `mailto:info@adoptionformsexpress.com`.
...
```html
<div class="tc-v2-embeddable-target" data-thrivecart-account="adoptionssimplified" data-thrivecart-tpl="v2" data-thrivecart-product="7" data-thrivecart-embeddable="tc-adoptionssimplified-7-DCTFYF"></div>
<script async src="//tinder.thrivecart.com/embed/v2/thrivecart.js" id="tc-adoptionssimplified-7-DCTFYF"></script>
```

ThriveCart product ID: 7
Embeddable token: `tc-adoptionssimplified-7-DCTFYF`
...
| Date | Change | Author |
|---|---|---|
| 2026-09-18 | v1.13 — **Third ThriveCart token regen for product 7 today — fifth overall.** Another round of ThriveCart admin changes by Tyler regenerated the token again. Product ID, account, and script src unchanged. **Old to new token:** `EIPBWZ` to `DCTFYF`. Swapped in `diy-adult-checkout.html` (2 places) and in the three current-spec references in this doc. Historical change-log entries left intact. | Claude / Tyler |
